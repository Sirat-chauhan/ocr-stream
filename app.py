...
def detect_doc_type(text: str) -> str:
    ...
    if aad_score > pan_score:   return "aadhaar"
    elif pan_score > aad_score: return "pan"
    elif pan_pattern and not aadhaar_pattern: return "pan"
    elif aadhaar_pattern and not pan_pattern: return "aadhaar"
    return "unknown"
